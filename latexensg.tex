...
\item update.kyl: Ce paquet télécharge et éxécute les mise à jour, il change ensuite le numéro de la version courrante dans le dispositif client
\item zeus.kyl: Ce script est lancé si on veut
\end{itemize}
